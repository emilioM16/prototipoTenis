                    ...
                    <div class="thumbnail">
                        <div class="caption">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="col-lg-6"><img src="img/delPotro.png" alt="..." class="img-rounded imagenJugador"></div>
                                    <div class="col-lg-6"><img src="img/wawrinka.png" alt="..." class="img-rounded imagenJugador"></div>
                                </div>
                            </div>
                        </div>
                    </div>
