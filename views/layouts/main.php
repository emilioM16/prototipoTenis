...
Modal::begin([
	...
	'header'=>'<h4 align="center">Buscar jugadores</h4>',
    ...
    <div class='col-lg-8 col-lg-offset-2'>
        <p align='justify'>".FAS::i('info')." Puede realizar la búsqueda de jugadores por <b>uno</b> de los siguientes criterios.</p>
            ...
            <div class='panel-body'>
                <form>
                    ...
                    <div class='form-group'>
                        ...
                        <input type='number' min='0' class='form-control' id='exampleInputPassword1' placeholder='Número de preclasificación'>
                    </div>
                    <div class='form-group'>
                        <label for='exampleInputPassword1'>País de nacimiento </label>
